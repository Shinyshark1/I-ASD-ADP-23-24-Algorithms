...
public class DynamicArrayTests
{
    ...
    public void TheDataSets_Fit_InTheDynamicArray()
    {
        ...
        var result7 = Record.Exception(() => new DynamicArray<int>(JsonConvert.DeserializeObject<LijstLeeg0>(sortingJson).Content));
        var result8 = Record.Exception(() => new DynamicArray<int?>(JsonConvert.DeserializeObject<LijstNull1>(sortingJson).Content));
