...
namespace Algorithms.Tests
{
    public class DoublyLinkedListTests
    {
        ...
        public void TheDataSets_Fit_InTheDoublyLinkedList()
        {
            ...
            var result7 = Record.Exception(() => new DoublyLinkedList<object>(JsonConvert.DeserializeObject<LijstLeeg0>(sortingJson).Content));
            var result8 = Record.Exception(() => new DoublyLinkedList<object>(JsonConvert.DeserializeObject<LijstNull1>(sortingJson).Content));
